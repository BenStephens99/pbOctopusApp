      ...
      <Modal isOpen={isOpen} onOpenChange={onOpenChange}>
        <ModalContent>
          ...
          <ModalBody>
            ...
            <Select label="Product" onChange={(e) => setProduct(e.target.value)}>
            ...
            <Select label="Area" onChange={(e) => setAreaCode(e.target.value)}>
          ...
          <ModalFooter>
            ...
            <Button isLoading={loading} color="primary" onPress={handleAddAccount}>
              Save
            </Button>
          </ModalFooter>
        </ModalContent>
