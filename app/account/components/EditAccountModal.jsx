...
export default function EditAccountModal(props) {
  ...
  const handleRemoveAccount = (accountNumberId) => {
    const newAccountNumbers = accountNumbers.filter(
      (accountNumber) => accountNumber.id !== accountNumberId
    );
  ...
  return (
    <>
      <Button color="primary" className="ml-auto" variant="ghost" onPress={onOpen}>
        Edit
      </Button>
          ...
          {(onClose) => (
            <>
              ...
              <ModalFooter>
                ...
                <Button color="primary" onPress={handleEditAccount}>
                  Save
                </Button>
              </ModalFooter>
            </>
